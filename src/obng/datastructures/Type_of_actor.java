 ...
 * to do this here, cause according to object calisthetics I need to wrap every basic
 * datatype - even Strings
 * 
 * @edit I am adding a placeholder in form of an int, actually I am planing to use
 * it in a hash map. But lets see whats coming up  
 * 
 * @author Neuly
 */
